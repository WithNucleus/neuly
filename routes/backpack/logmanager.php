...
Route::namespace('App\Http\Controllers\Admin')->middleware('web', config('backpack.base.middleware_key', 'admin'))->prefix(config('backpack.base.route_prefix', 'admin'))->group(function () {
