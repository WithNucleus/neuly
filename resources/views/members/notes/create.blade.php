        ...
        <div class="row">
            <div class="col-12 clearfix">
                <h1 class="h2 float-left">
                    <i class="fad fa-clipboard-list text-info"></i> New Note
                </h1>
                <p class="mb-0 font-size-small float-right d-inline-block ml-2">
                    <a href="{{ route('member.notes.index') }}" class="btn btn-danger"><i class="fad fa-arrow-alt-circle-left"></i> Go Back</a>
                </p>
            </div>
        </div>
        <div class="row">
