<div class="widget-controls mb-3">
    <div class="d-flex align-items-stretch">
        <div class="position-relative">
            <button class="btn btn-sm has-accordion-arrow filter-control" type="button" data-bs-toggle="collapse" data-bs-target="#combined-feed-type" aria-expanded="false" aria-controls="media-type">
                Category Filter
            </button>
        ...
        <div class="position-relative">
            <button class="btn btn-sm has-accordion-arrow filter-control" type="button" data-bs-toggle="collapse" data-bs-target="#combined-feed-focus" aria-expanded="false" aria-controls="media-type">
                Focus Filter
            </button>
