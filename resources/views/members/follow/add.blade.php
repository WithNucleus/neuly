    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            <form action="{{ route('member.follow.store', ['entity' => $entity, 'id' => $id]) }}" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                ...
                <div>
                    <input type="checkbox" name="email_notification" id="email_notification"> Email notifications
                </div>
                <div>
                    <input type="checkbox" name="app_notification" id="app_notification"> Neuly notifications
                </div>
