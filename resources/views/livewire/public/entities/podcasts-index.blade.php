    ...
    <div class="entity-index-sidebar">
        <x-entities.offcanvas-sidebar>
            ...
            <div class="my-4">
                ...
                <x-livewire-filters.checkbox-multiple-with-count wireModel="filters.focus" id="filter-focus" :options="$focusOptions" :currentFilters="$filters['focus']" countName="podcasts_count" />
            </div>

            <div class="my-4">
                <h4 class="h5 text-body-emphasis">Podcasts</h4>
    ...
    <div class="entity-index-listings w-100">
        ...
        <div>
            @forelse($records as $record)
                <livewire:public.entities.show.podcast-widget :record="$record" :wire:key="$record->slug" />
            @empty
