...
class ResearchOrganizationsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $path = route('insights.research-organizations');

        return view('discover.insights.research-organizations.index', compact('data', 'path', 'sort', 'currentFilters', 'focusesFilter'));
    }
    ...
    private function filterByFocus($query, $focusNames)
    {
        ...
        return $query->whereIn('company_research.research_id', $subquery);
    }
}
