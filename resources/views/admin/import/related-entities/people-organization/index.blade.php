            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card card-body">
                        ...
                        <h3 class="h4">Import Related People To Organization</h3>
                        <p class="mb-0">
                            <strong>Requirements</strong>
                        </p>
                        <ul>
                            <li>Allowed columns: {{ implode(', ', $allowedColumns) }}</li>
                        </ul>

                        @include('admin.includes.status-messages')

                        <form action="{{ route('import.related-entities.people-organization.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <table class="table">
                            ...
                            @foreach($importResults as $result)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('import.related-entities.people-organization.results', $result->id) }}" class="btn btn-sm btn-link"><i class="la la-eye"></i> Preview</a>
                                    </td>
                                    <td>
                                        @if($countFailures = $result->failures()->count())
                                            <a href="{{ route('import.related-entities.people-organization.failures', $result->id) }}" class="btn btn-sm btn-link">
