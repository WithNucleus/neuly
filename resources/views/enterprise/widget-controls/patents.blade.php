<div class="patent-controls mb-3">
    <div class="d-flex align-items-stretch">
        ...
        <div class="number-pages form-inline ml-4">
            <select id="patent-pages" class="custom-select auto-width">
            ...
            <label for="patent-pages" class="ml-2">items</label>
        </div>
    </div>
    <div class="category">
        <div class="collapse" id="patent-focus">
