        ...
        <div class="row">
            @forelse($records as $record)
                <div class="d-md-flex mb-5">
                    <div class="flex-shrink-0 me-md-3 me-lg-4">
                    ...
                    <div>
                        ...
                        <div class="d-flex flex-wrap ">
                            <a href="{{ $record->url }}" target="_blank" rel="noopener noreferrer" class="btn btn-primary rounded-0 my-3 me-3">Buy Now</a>
                            <button type="button" class="btn btn-ghost-primary rounded-0 my-3" data-bs-toggle="modal" data-bs-target="#details-{{ $record->slug }}">More Details</button>
                        </div>
                    </div>
                    <div class="modal fade" id="details-{{ $record->slug }}" tabindex="-1" aria-labelledby="details-label-details-{{ $record->slug }}" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header bg-primary-subtle">
                                    <h3 class="modal-title h5 mb-0 mt-1" id="details-label-details-{{ $record->slug }}">{{ $record->name }}</h3>
