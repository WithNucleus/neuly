            ...
            <div class="row mt-4">
                <div class="col-12">
                    <div class="card card-body">
                        ...
                        <h3 class="h4">Import Related Locations</h3>
                        <p class="mb-0">
                        ...
                        <form action="{{ route('import.related-entities.locations.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <table class="table">
                            ...
                            @foreach($importResults as $result)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('import.related-entities.locations.results', $result->id) }}" class="btn btn-sm btn-link"><i class="la la-eye"></i> Preview</a>
                                    </td>
                                    <td>
                                        @if($countFailures = $result->failures()->count())
                                            <a href="{{ route('import.related-entities.locations.failures', $result->id) }}" class="btn btn-sm btn-link">
