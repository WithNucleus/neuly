...
//Insights Widgets
    Route::group([
        ...
        Route::group([
            ...
            Route::get('/clinical-trials-pipeline',
                'ClinicalTrialPipelineController@show')->name('clinicaltrials.pipeline');
        });
    });
...
// Listing Requests
    ...
    Route::post('/listing/request/finish',
        'Index\ListingRequestController@processData')->name('listing.request.finish');
    Route::post('/listing/request/{type}',
        'Index\ListingRequestController@entityForm')->name('listing.request.investor');
...
// Search
    ...
    Route::post('/search/organizations',
        'index\SearchController@showOrganizationResults')->name('search.organizations');
    ...
    Route::post('/search/clinicaltrials',
        'index\SearchController@showClinicalTrialsResults')->name('search.clinicaltrials');
    Route::get('/search/clinicaltrials/{term}',
        'Index\SearchController@showClinicalTrialsResults')->name('search.clinicaltrials.term');
...
// Thanks for Registering Page
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => '/dashboard'], function () {
            ...
            // Follow lists
            Route::post('/follow-lists/ajax-store',
                'Dashboard\FollowListsController@ajaxStore')->name('member.follow-lists.ajaxStore');
            Route::post('/follow-lists/validate-name',
                'Dashboard\FollowListsController@validateName')->name('member.follow-lists.validateName');
            ...
            Route::get('/notifications/{notification}',
                'NotificationController@show')->name('dashboard.notifications.show');
            Route::get('/notifications/{notification}/read', 'NotificationController@setRead');
        });

        // Follow / Unfollow actions
        Route::get('/follow//get-modal/{id}/{type}',
            'Dashboard\FollowController@getModal')->name('member.follow.getModal');
        ...
        Route::post('/user/settings/validateurl',
            'Index\UserProfileController@checkMemberUrl')->name('user.validate.member_url');
    });
...
// Route::get('/charts/topLocations', 'Index\ChartController@topLocations')->name('charts.top_locations');
    ...
    Route::get('/admin/companyperson/{company_id}/person/{person_id}/remove',
        'Admin\CompanyPersonController@remove')->name('companyperson.remove');
    ...
    Route::get('/admin/investor/{investor_id}/person/{person_id}/remove',
        'Admin\InvestorPersonController@remove')->name('investorperson.remove');
...
// Job Application Files
    ...
    Route::get('/admin/jobapps/{id}/coverletter',
        'Index\JobApplicationController@getCoverLetter')->name('jobsapp.coverletter');
...
// Admin Routes
    ...
    Route::get('/members/{member_url}/lists/{slug}',
        'Dashboard\FollowListsController@showPublic')->name('members.follow-lists.public');
