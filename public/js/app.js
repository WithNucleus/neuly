...
$(function () {
  var searchClient = algoliasearch(ALGOLIA_APP_ID, ALGOLIA_SECRET);
  var instantSearchRouter = instantsearch.routers.history();
  /**
  ...
  jobsSearch.start(); // Set the InstantSearch index UI state from external events.

  function setInstantSearchUiState(indexUiState) {
    companySearch.setUiState(function (uiState) {
      return _objectSpread(_objectSpread({}, uiState), {}, _defineProperty({}, 'companies', _objectSpread(_objectSpread({}, uiState['companies']), {}, {
