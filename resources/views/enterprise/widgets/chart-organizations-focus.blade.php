<div>
    <div class="resizable-widget-container">
        <canvas id="organizationFocusChart" style="height: 500px" data-labels="{{ $labels }}" data-values="{{ $values }}" data-colors="{{ $colors }}" data-url="{{ route('discover.organizations') }}?filter[focus]="></canvas>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let canvas = document.getElementById("organizationFocusChart");
