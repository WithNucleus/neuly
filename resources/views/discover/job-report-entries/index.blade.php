...
@section('content')
    ...
    <div class="container my-5">
        ...
        <p class="lead text-center max-width-780 mx-auto">
        ...
        <form method="post" action="{{ route('job-report-entry.store') }}" style="max-width: 600px;" class="mx-auto">
            ...
            <div class="mb-3">
                <label class="fw-bold text-uppercase" for="company">Company <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="company" id="company" value="{{ old('company') }}" required>
            </div>

            <div class="mb-3">
                <label class="fw-bold text-uppercase" for="position">Position <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="position" id="position" value="{{ old('position') }}" required>
            </div>

            <div class="mb-3">
                <label class="d-block fw-bold" for="currently_hiring">Are you currently hiring? <span class="text-danger">*</span></label>
            ...
            <div class="js-currently-hiring-details-wrapper" style="display: none">
                <div class="mb-3">
                    <label class="d-block fw-bold">If you are hiring, where can we find the job listings?</label>
                ...
                <div class="mb-3">
                    <label class="fw-bold text-uppercase">Please provide the URL(s) to your job listings</label>
            ...
            <div class="mb-3">
                <label class="d-block fw-bold">How many employees does your company current have? <span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
                <label class="d-block fw-bold">What Role is most important for you to fill today?</label>
            ...
            <div class="mb-3">
                <label class="d-block fw-bold">What, if anything, is currently holding you back from expanding your workforce?</label>
            ...
            <div class="mb-3">
                <label class="d-block fw-bold">What is your 12-24 month forecast concerning psychedelic industry job growth?</label>
