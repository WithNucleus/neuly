<nav id="primary-nav" class="navbar navbar-dark fixed-top bg-dark flex-xl-nowrap shadow navbar-expand-lg">
    <div class="container-fluid">
        <a class="navbar-brand ms-3" href="/"><img src="{{ asset('images/neuly-logo-dark.png') }}" alt="Neuly"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="ms-3 me-auto">
                <form class="global-search-form form-inline mt-3 mt-lg-0" method="post" action="{{ route('search') }}">
                    ...
                    <button class="btn global-search-button ms-2 my-2 my-sm-0" type="submit" title="Search Neuly"><i class="far fa-search"></i></button>
                </form>
            </div>
