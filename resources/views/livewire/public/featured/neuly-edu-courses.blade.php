            ...
            @forelse($records as $record)
                <div wire:key="{{ $record->id }}" class="mb-4">
                    <div wire:click="goListing('{{ $record->id }}')" class="neuly-edu-course-item bg-body">
                        <div class="image">
                            <img src="{{ $record->companies->first()->entityImageUrl ?? asset('images/image-placeholder-course.png') }}"
                        ...
                        <div class="text">
                            ...
                            <div
                                class="d-md-flex justify-content-between mt-3 text-primary text-uppercase fw-bold">
